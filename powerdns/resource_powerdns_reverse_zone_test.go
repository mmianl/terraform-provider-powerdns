...
func TestAccPowerDNSReverseZone_NetworkAddress(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:     func() { testAccPreCheck(t) },
		Providers:    testAccProviders,
		CheckDestroy: testAccCheckPDNSZoneDestroy,
		Steps: []resource.TestStep{
			{
				Config: testAccPowerDNSReverseZoneConfig_NetworkAddress,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckPDNSZoneExists("powerdns_reverse_zone.test"),
					resource.TestCheckResourceAttr(
						"powerdns_reverse_zone.test", "name", "10.in-addr.arpa."),
					resource.TestCheckResourceAttr(
						"powerdns_reverse_zone.test", "kind", "Master"),
					resource.TestCheckResourceAttr(
						"powerdns_reverse_zone.test", "nameservers.0", "ns1.example.com."),
				),
			},
		},
	})
...
const testAccPowerDNSReverseZoneConfig_NetworkAddress = `
resource "powerdns_reverse_zone" "test" {
  network_address    = "10.0.0.0"
  zone_prefix_length = 8
  kind              = "Master"
  nameservers       = ["ns1.example.com."]
}
`
